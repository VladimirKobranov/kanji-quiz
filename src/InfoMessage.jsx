...
function InfoMessage() {
    return (
        <Box width={isBrowser ? '500px' : 'auto'}>
            <Text className={isBrowser ? Content.infoGreetingsJap : Content.infoGreetingsJapMobile}>
                いらっしゃいませ!
            </Text>
            <Text className={isBrowser ? Content.infoGreetingsEngl : Content.infoGreetingsEnglMobile} mb='20px'>
                or greetings!
            </Text>
            <Text className={isBrowser ? Content.infoGreetingsText : Content.infoGreetingsTextMobile} mb='20px'>
            ...
            <Text className={isBrowser ? Content.infoGreetingsGoodLuckJap : Content.infoGreetingsGoodLuckJapMobile}>
                頑張って!
            </Text>
        </Box>
    )
